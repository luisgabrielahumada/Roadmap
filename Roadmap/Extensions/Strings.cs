...
public static class StringExtensions
{
    ...
    {
        return amount.ToString("C", new CultureInfo(cultureCode));
    }
    ...
    /// <summary>
    /// Parse to format PayU
    /// </summary>
    /// <param name="value">The amount</param>
    /// <returns>The formatted string result</returns>
    public static string RemoveCommasDecimals(this decimal value)
    {
        return value.ToString("N").Replace(",","").Replace(".","");
    }
}